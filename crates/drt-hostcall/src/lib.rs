...
/// reason is upstream.** A0 has landed (dv ABI 2, diluvium v0.16.0) and
/// this is still true.
///
...
///
/// What the merged core carries instead is a host-side *push*,
...
/// hostcall reply -- is `dv_queue_push` carrying msgpack, and the adopted
/// value is not on any of them. Measured against the merged core, both
