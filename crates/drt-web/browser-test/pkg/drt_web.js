...
export class Swarm {
     ...
     */
    __panicForTests() {
        const ret = wasm.swarm___panicForTests(this.__wbg_ptr);
        if (ret[1]) {
     ...
     */
    alive() {
        const ret = wasm.swarm_alive(this.__wbg_ptr);
        if (ret[2]) {
     ...
     */
    budget(id) {
        const ret = wasm.swarm_budget(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    cachedSize(id) {
        const ret = wasm.swarm_cachedSize(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     */
    caps(id) {
        const ret = wasm.swarm_caps(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    holds(id, cap) {
        ...
        const ret = wasm.swarm_holds(this.__wbg_ptr, id, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     */
    ids() {
        const ret = wasm.swarm_ids(this.__wbg_ptr);
        if (ret[3]) {
     ...
     */
    kill(id) {
        const ret = wasm.swarm_kill(this.__wbg_ptr, id);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     * @param {number} spawns_per_step
     */
    constructor(host, max_instances, spawns_per_step) {
        const ret = wasm.swarm_new(host, max_instances, spawns_per_step);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     */
    parent(id) {
        const ret = wasm.swarm_parent(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     * @returns {boolean}
     */
    push(id, queue, msgpack) {
        const ptr0 = passStringToWasm0(queue, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(msgpack, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.swarm_push(this.__wbg_ptr, id, ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
     ...
     */
    resident(id) {
        const ret = wasm.swarm_resident(this.__wbg_ptr, id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] !== 0;
    ...
    root(code, caps, budget) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.swarm_root(this.__wbg_ptr, ptr0, len0, caps, budget);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
     ...
     */
    step() {
        const ret = wasm.swarm_step(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0] >>> 0;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./drt_web_bg.js": import0,
    };
}

const SwarmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_swarm_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('drt_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
